...
#fi
copy_hook_if_modified "$1/config/git-hooks/pre-commit.sh" "$1/.git/hooks/pre-commit" "pre-commit"
...
#fi
copy_hook_if_modified "$1/config/git-hooks/pre-push.sh" "$1/.git/hooks/pre-push" "pre-push"

#copy_hook_if_modified "$1/config/lint-ing/lint.xml" "$1/lint.xml" "lint.xml"

#copy_hook_if_modified "$1/config/.editorconfig" "$1/.editorconfig" ".editorconfig"
#}
